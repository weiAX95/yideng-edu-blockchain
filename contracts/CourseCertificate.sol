...
contract CourseCertificate is ERC721, AccessControl {
  ...
  // 事件
  event CertificateMinted(uint256 indexed tokenId, string web2CourseId, address indexed student);
   ...
   * @param web2CourseId 课程ID
   */
  function hasCertificate(address student, string memory web2CourseId) public view returns (bool) {
